...
THEORY ListConstantsX IS
  List_Valuable_Constants(Machine(Maze))==(?);
  Inherited_List_Constants(Machine(Maze))==(?);
  List_Constants(Machine(Maze))==(?)
END
&
THEORY ListSetsX IS
...
THEORY ListPropertiesX IS
  ...
  List_Properties(Machine(Maze))==(btrue)
END
&
...
THEORY ListOfIdsX IS
  List_Of_Ids(Machine(Maze)) == (? | ? | ? | ? | ? | ? | ? | ? | Maze);
  List_Of_HiddenCst_Ids(Machine(Maze)) == (? | ?);
  List_Of_VisibleCst_Ids(Machine(Maze)) == (?);
